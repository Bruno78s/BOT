...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand((command) => command.setName("slowmode").setDescription("Define o modo lento de um canal.").addIntegerOption((option) => option.setName("segundos").setDescription("Tempo em segundos, 0 a 21600.").setMinValue(0).setMaxValue(21600).setRequired(true)).addChannelOption((option) => option.setName("canal").setDescription("Canal afetado.").addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement, ChannelType.GuildForum, ChannelType.PublicThread, ChannelType.PrivateThread)).addStringOption((option) => option.setName("motivo").setDescription("Motivo da alteração.").setMaxLength(900)))
    ...
    .addSubcommand((command) => command.setName("pin").setDescription("Fixa uma mensagem pelo ID.").addStringOption((option) => option.setName("mensagem_id").setDescription("ID da mensagem.").setRequired(true).setMinLength(15).setMaxLength(25)).addChannelOption((option) => option.setName("canal").setDescription("Canal da mensagem.").addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement, ChannelType.GuildForum, ChannelType.PublicThread, ChannelType.PrivateThread)).addStringOption((option) => option.setName("motivo").setDescription("Motivo.").setMaxLength(900)))
    .addSubcommand((command) => command.setName("unpin").setDescription("Remove o fixado de uma mensagem pelo ID.").addStringOption((option) => option.setName("mensagem_id").setDescription("ID da mensagem.").setRequired(true).setMinLength(15).setMaxLength(25)).addChannelOption((option) => option.setName("canal").setDescription("Canal da mensagem.").addChannelTypes(ChannelType.GuildText, ChannelType.GuildAnnouncement, ChannelType.GuildForum, ChannelType.PublicThread, ChannelType.PrivateThread)).addStringOption((option) => option.setName("motivo").setDescription("Motivo.").setMaxLength(900)))
